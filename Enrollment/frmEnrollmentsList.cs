    ...
    public partial class frmEnrollmentsList : Form
    {
        ...
        private void frmEnrollmentsList_Load(object sender, EventArgs e)
        {
            ...
            if (dgvEnrollments.Rows.Count > 0)
            {
                ...
                dgvEnrollments.Columns[1].HeaderText = "Full Name";
                dgvEnrollments.Columns[1].Width = 200;

                dgvEnrollments.Columns[2].HeaderText = "Course Name";
                dgvEnrollments.Columns[2].Width = 180;

                dgvEnrollments.Columns[3].HeaderText = "Status";
                dgvEnrollments.Columns[3].Width = 120;

                dgvEnrollments.Columns[4].HeaderText = "Grade";
